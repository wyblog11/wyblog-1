...
#rightside>div>a:hover {
  color: #fff;
  background: rgb(22, 119, 179);
  border-color: rgb(22, 119, 179);
  -webkit-box-shadow: 0 8px 12px -3px rgba(22, 119, 179, .2);
  -moz-box-shadow: 0 8px 12px -3px rgba(22, 119, 179, .2);
  -ms-box-shadow: 0 8px 12px -3px rgba(22, 119, 179, .2);
  -o-box-shadow: 0 8px 12px -3px rgba(22, 119, 179, .2);
  box-shadow: 0 8px 12px -3px rgba(22, 119, 179, .2);
}
